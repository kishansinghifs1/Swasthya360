...
# Step 1:Chatbot Core
# ===================================
def swasthya360_agent(prompt: str) -> str: 
    """
    This function initializes and returns a Groq AI agent configured for the Swasthya360 application.
    ...
    * [Medication tip 2]
    ...
    Now respond to the user's message using the EXACT format above for the first question regarding symptoms if user continues to ask the question kindly respond in 100 words for short crispy output.
    """
    try:
